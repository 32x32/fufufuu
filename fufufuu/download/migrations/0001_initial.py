...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'DownloadLink', fields ['path', 'ip_address', 'created_by']
        db.create_index('download_link', ['path', 'ip_address', 'created_by_id'])


    def backwards(self, orm):
        # Removing index on 'DownloadLink', fields ['path', 'ip_address', 'created_by']
        db.delete_index('download_link', ['path', 'ip_address', 'created_by_id'])
    ...
    models = {
        ...
        'download.downloadlink': {
            'Meta': {'db_table': "'download_link'", 'object_name': 'DownloadLink', 'index_together': "[('path', 'ip_address', 'created_by')]"},
