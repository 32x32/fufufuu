...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tag', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User'], blank=True, null=True, on_delete=models.SET_NULL, related_name='+')),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User'], blank=True, null=True, on_delete=models.SET_NULL, related_name='+')),
    ...
    models = {
        ...
        'tag.tag': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.User']", 'blank': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'related_name': "'+'"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100'}),
            'tag_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.User']", 'blank': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'related_name': "'+'"}),
