...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('manga', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User'], related_name='+', on_delete=models.SET_NULL, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.User'], related_name='+', on_delete=models.SET_NULL, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, default='Untitled', db_index=True)),
            ...
            ('tank', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tag.Tag'], related_name='+', on_delete=models.SET_NULL, blank=True)),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tag.Tag'], related_name='+', on_delete=models.SET_NULL, blank=True)),
    ...
    models = {
        ...
        'manga.manga': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['tag.Tag']", 'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['account.User']", 'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'favorite_users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'manga_favorites'", 'to': "orm['account.User']", 'symmetrical': 'False', 'blank': 'True'}),
            'html': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tank': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['tag.Tag']", 'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['account.User']", 'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
