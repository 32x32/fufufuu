...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('manga', (
            ...
            ('tank', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, related_name='+', to=orm['tag.Tag'])),
            ('collection', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, related_name='+', to=orm['tag.Tag'])),
    ...
    models = {
        ...
        'manga.manga': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'related_name': "'+'", 'to': "orm['tag.Tag']"}),
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'favorite_users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'related_name': "'manga_favorites'", 'to': "orm['account.User']"}),
            'html': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tank': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'related_name': "'+'", 'to': "orm['tag.Tag']"}),
