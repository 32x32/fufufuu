$ ->
    ...
    ad295298 = '<iframe border=0 frameborder=0 marginheight=0 marginwidth=0 width=780 height=142 scrolling=no allowtransparency=true src=http://adserver.juicyads.com/adshow.php?adzone=295298></iframe>'
